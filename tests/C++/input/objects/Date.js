...
console.log(
    ...
    currentDate.toISOString().toString().substring(0, 5)
);
console.log(
    "Date.prototype.toJSON:",
    currentDate.toJSON().toString().substring(0, 5)
);
console.log(
    "Date.prototype.valueOf:",
    currentDate.valueOf().toString().substring(0, 5)
);
...
console.log(
    ...
    currentDate.getTime().toString().substring(0, 5)
);
console.log(
