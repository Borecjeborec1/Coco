...
int main(){
  ...
  using path = __path__;
std::cout << std::string("path.sep:") << path::sep << '\n';
std::cout << std::string("path.delimiter:") << path::delimiter << '\n';
std::cout << std::string("path.basename:") << path::basename(std::string("/test/user/folder1/file.txt")) << '\n';
std::cout << std::string("path.dirname:") << path::dirname(std::string("/test/user/folder1/file.txt")) << '\n';
std::cout << std::string("path.extname:") << path::extname(std::string("/test/user/folder1/file.txt")) << '\n';
std::cout << std::string("Joined Path:") << path::join(std::string("folder1"), std::string("file.txt")) << '\n';
std::cout << std::string("path.isAbsolute('/test/user'): ") << path::isAbsolute(std::string("/test/user")) << '\n';
std::cout << std::string("path.normalize:") << path::normalize(std::string("/test/user//folder1/../folder2/file.txt")) << '\n';
auto parsed = path::parse(std::string("/test/user/folder1/file.txt")) ; 

std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed["root"]), // Unknown type: {"type":"Literal","start":717,"end":721,"loc":{"start":{"line":17,"column":58,"index":717},"end":{"line":17,"column":62,"index":721}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed["dir"]), // Unknown type: {"type":"Literal","start":787,"end":791,"loc":{"start":{"line":18,"column":57,"index":787},"end":{"line":18,"column":61,"index":791}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed["base"]), // Unknown type: {"type":"Literal","start":858,"end":862,"loc":{"start":{"line":19,"column":58,"index":858},"end":{"line":19,"column":62,"index":862}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed["ext"]), // Unknown type: {"type":"Literal","start":928,"end":932,"loc":{"start":{"line":20,"column":57,"index":928},"end":{"line":20,"column":61,"index":932}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed["name"]), // Unknown type: {"type":"Literal","start":999,"end":1003,"loc":{"start":{"line":21,"column":58,"index":999},"end":{"line":21,"column":62,"index":1003}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
auto parsed2 = path::parse(std::string("test/user/folder1/file.txt")) ; 

std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed2["root"]), // Unknown type: {"type":"Literal","start":1128,"end":1132,"loc":{"start":{"line":23,"column":59,"index":1128},"end":{"line":23,"column":63,"index":1132}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed2["dir"]), // Unknown type: {"type":"Literal","start":1199,"end":1203,"loc":{"start":{"line":24,"column":58,"index":1199},"end":{"line":24,"column":62,"index":1203}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed2["base"]), // Unknown type: {"type":"Literal","start":1271,"end":1275,"loc":{"start":{"line":25,"column":59,"index":1271},"end":{"line":25,"column":63,"index":1275}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed2["ext"]), // Unknown type: {"type":"Literal","start":1342,"end":1346,"loc":{"start":{"line":26,"column":58,"index":1342},"end":{"line":26,"column":62,"index":1346}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed2["name"]), // Unknown type: {"type":"Literal","start":1414,"end":1418,"loc":{"start":{"line":27,"column":59,"index":1414},"end":{"line":27,"column":63,"index":1418}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
auto parsed3 = path::parse(std::string("C://test/user/folder1/file.txt")) ; 

std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed3["root"]), // Unknown type: {"type":"Literal","start":1547,"end":1551,"loc":{"start":{"line":29,"column":59,"index":1547},"end":{"line":29,"column":63,"index":1551}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed3["dir"]), // Unknown type: {"type":"Literal","start":1618,"end":1622,"loc":{"start":{"line":30,"column":58,"index":1618},"end":{"line":30,"column":62,"index":1622}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed3["base"]), // Unknown type: {"type":"Literal","start":1690,"end":1694,"loc":{"start":{"line":31,"column":59,"index":1690},"end":{"line":31,"column":63,"index":1694}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed3["ext"]), // Unknown type: {"type":"Literal","start":1761,"end":1765,"loc":{"start":{"line":32,"column":58,"index":1761},"end":{"line":32,"column":62,"index":1765}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.parse:") << JS_replace(JS_toString(parsed3["name"]), // Unknown type: {"type":"Literal","start":1833,"end":1837,"loc":{"start":{"line":33,"column":59,"index":1833},"end":{"line":33,"column":63,"index":1837}},"value":{},"raw":"/\"/g","regex":{"pattern":"\"","flags":"g"}}, std::string("")) << '\n';
std::cout << std::string("path.relative:") << path::relative(std::string("/test/user/folder1"), std::string("/test/user/folder2")) << '\n';
  return 0;
}  
