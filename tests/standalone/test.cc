...
public:
    ...
    std::string toLocaleString() const
    {
        ...
        if (std::strftime(buffer, sizeof(buffer), "%x, %X", &timeInfo) == 0)
        {
            return "";
        }
...
std::cout << std::string("Date.prototype.toISOString:") << currentDate.toISOString() << '\n';
std::cout << std::string("Date.prototype.toJSON:") << currentDate.toJSON() << '\n';
std::cout << std::string("Date.prototype.valueOf:") << JS_valueOf(currentDate) << '\n';
...
std::cout << std::string("Date.prototype.getTime:") << currentDate.getTime() << '\n';
std::cout << std::string("Date.prototype.getTimezoneOffset:") << currentDate.getTimezoneOffset() << '\n';
std::cout << std::string("Date.now:") << JS_substring(JS_toString(__Date__::now()), static_cast<int>(0), static_cast<int>(5)) << '\n';
std::cout << std::string("Date.UTC:") << __Date__::UTC(static_cast<int>(2023), static_cast<int>(0), static_cast<int>(15)) << '\n';
std::cout << std::string("Date.parse:") << __Date__::parse(std::string("2023-01-15T12:00:00Z")) << '\n';
currentDate.setFullYear(static_cast<int>(2024));
std::cout << std::string("Date.prototype.setFullYear:") << '\n';
std::cout << std::string("Date.prototype.getFullYear:") << currentDate.getFullYear() << '\n';
currentDate.setMonth(static_cast<int>(4));
std::cout << std::string("Date.prototype.setMonth:") << '\n';
std::cout << std::string("Date.prototype.getMonth:") << currentDate.getMonth() << '\n';
currentDate.setDate(static_cast<int>(29));
std::cout << std::string("Date.prototype.setDate:") << '\n';
std::cout << std::string("Date.prototype.getDate:") << currentDate.getDate() << '\n';
currentDate.setHours(static_cast<int>(10));
std::cout << std::string("Date.prototype.setHours:") << '\n';
std::cout << std::string("Date.prototype.getHours:") << currentDate.getHours() << '\n';
currentDate.setMinutes(static_cast<int>(30));
std::cout << std::string("Date.prototype.setMinutes:") << '\n';
std::cout << std::string("Date.prototype.getMinutes:") << currentDate.getMinutes() << '\n';
currentDate.setSeconds(static_cast<int>(45));
std::cout << std::string("Date.prototype.setSeconds:") << '\n';
std::cout << std::string("Date.prototype.getSeconds:") << currentDate.getSeconds() << '\n';
currentDate.setMilliseconds(static_cast<int>(500));
