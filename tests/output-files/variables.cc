...
auto x = static_cast<double>(1000) ; 

auto y = static_cast<double>(30) ; 

if (true) { 
auto x = static_cast<double>(40) ; 

auto y = static_cast<double>(50) ; 
...
int main(){
  auto x = static_cast<double>(10) ; 

auto PI = -static_cast<double>(3.14)  ; 
